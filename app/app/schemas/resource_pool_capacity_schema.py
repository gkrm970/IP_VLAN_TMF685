...
class ResourcePoolCapacityBase(BaseModel):
    ...
    capacity_amount: str | None = Field(None, alias="capacityAmount", description=_NAME_DESCRIPTION)
    capacity_amount_from: str | None = Field(None, alias="capacityAmountFrom", description=_NAME_DESCRIPTION)
    capacity_amount_remaining: str | None = Field(None, alias="capacityAmountRemaining", description=_NAME_DESCRIPTION)
    capacity_amount_to: str | None = Field(None, alias="capacityAmountTo", description=_NAME_DESCRIPTION)
    range_interval: str | None = Field(None, alias="rangeInterval", description=_NAME_DESCRIPTION)
