...
class ResourceRef(Base):
    id: Mapped[str] = mapped_column(String(255), primary_key=True, index=True, default=True)
    ...
    resource_pool_id: Mapped[str] = mapped_column(ForeignKey("resource_pool.id"), unique=True)
