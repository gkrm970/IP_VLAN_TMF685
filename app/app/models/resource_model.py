...
class ResourceCapacityDemand(Base):
    ...
    # 1..0..* relationship with ResourceCapacityDemand table and PlaceRef table (ResourceCapacityDemand table is parent)
    place_ref_resource = relationship("PlaceRef", back_populates="applied_capacity_amount_resource", uselist=True)
